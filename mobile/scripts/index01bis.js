...
function crtnew(type,eid,cls,content,attributes,father) {
...
const newDiv = crtnew("div","","","","",body)
const newHheader = crtnew("header","","","","",newDiv)
const newH1 = crtnew("h1","","","Contacts","",newHheader)
const headerButton = crtnew("button","","","","",newHheader)
headerButton.innerHTML = headerSVG;
const newSection = crtnew("section","","","","",newDiv)
newSection.innerHTML = sectionSVG;
const newSectionInput = crtnew("input","contacts","","",{type: "search", name: "contacts", placeholder: "Contacts"},newSection);
const newNav = crtnew("nav","","","","",newDiv)
const navFirstDiv = crtnew("div","","","","",newNav)
const navFirstDivH2 = crtnew("h2","","","Last Contacted","",navFirstDiv)
const navSecondDiv = crtnew("div","","","","",newNav)
for (let i = 0; i < 10; i++) {
  let navDivs = crtnew("div","","last_contacts","","",navSecondDiv)
  let navDivsDiv1 = crtnew("div","","","","",navDivs);
  let navDivsDiv1Img = crtnew("img","","","",{src:"./pictures/profile-pic.png", alt:"Last contact profile picture"},navDivsDiv1);
  let navDivsDiv2 = crtnew("div","","","","",navDivs);
}
const newMain = crtnew("main","","","","",body)
for (let i = 0; i < messageArray.length; i++) {
  let newMainDiv = crtnew("div","","","","",newMain);
  let newMainDivDiv1 = crtnew("div","","","","",newMainDiv);
  let newMainDivDiv1A = crtnew("a","","","",{href:messageArray[i].link},newMainDivDiv1);
  let newMainDivDiv1AImg = crtnew("img","","","",{src:messageArray[i].picsrc, alt:messageArray[i].picalt},newMainDivDiv1A);
  let newMainDivDiv2 = crtnew("div","","message","","",newMainDiv);
  let newMainDivDiv2Div = crtnew("div","","","","",newMainDivDiv2);
  let newMainDivDiv2DivSpan1 = crtnew("span","","",messageArray[i].name,"",newMainDivDiv2Div);
  let newMainDivDiv2DivSpan2 = crtnew("span","","",messageArray[i].time,"",newMainDivDiv2Div);
  let newMainDivDiv2Span = crtnew("span","","",messageArray[i].text,"",newMainDivDiv2);
}
