...
let text_stats = document.createElement("div")
text_stats.className="text-stats"
statics.appendChild(text_stats)
let timeSpan = document.createElement("span")
timeSpan.className="span"
let timeSpantext = document.createTextNode("Time trained")
timeSpan.appendChild(timeSpantext)
text_stats.appendChild(timeSpan)
let dailySpan = document.createElement("span")
dailySpan.className="span"
let dailySpantext = document.createTextNode("Daily streak")
dailySpan.appendChild(dailySpantext)
text_stats.appendChild(dailySpan)

let number_stats = document.createElement("div")
number_stats.className="number-stats"
statics.appendChild(number_stats)
let h3_1 = document.createElement("h3")
let h3text = document.createTextNode("45min")
h3_1.appendChild(h3text)
let h3_2 = document.createElement("h3")
let h3_text = document.createTextNode("3 days")
h3_2.appendChild(h3_text)
number_stats.appendChild(h3_1)
number_stats.appendChild(h3_2)
...
let textSkills = document.createTextNode("Skills")
skills.appendChild(textSkills)
center.appendChild(skills)
let badge = document.createElement("span")
badge.className="badges"
let textBadge = document.createTextNode("Badges")
...
stati.className="stati"
document.body.appendChild(stati)

let stato = document.createElement("div")
stato.className="stato"
stati.appendChild(stato)

let foto_obbiettivo = document.createElement("div")
foto_obbiettivo.className="foto-obbiettivo"
stato.appendChild(foto_obbiettivo)
let imgGinocchio = document.createElement("img")
imgGinocchio.src = "/mobile-profile/assets/ginocchio-martello.png"
foto_obbiettivo.appendChild(imgGinocchio)

let textLVL = document.createElement("div")
textLVL.className="div"
stato.appendChild(textLVL)
let h5 = document.createElement("h5")
h5.className="h5"
let h5text = document.createTextNode("Breath Focus")
h5.appendChild(h5text)
textLVL.appendChild(h5)
let paLVL = document.createElement("p")
paLVL.className="p"
let paText = document.createTextNode("Level 2")
paLVL.appendChild(paText)
stato.appendChild(paLVL)
let line = document.createElement("img")
line.src = "/mobile-profile/assets/linea-stats.png"
stato.appendChild(line)


let stato2 = document.createElement("div")
stato2.className="stato"
stati.appendChild(stato2)

let foto2 = document.createElement("div")
foto2.className="foto-obbiettivo"
stato2.appendChild(foto2)
let shape = document.createElement("img")
shape.src = "/mobile-profile/assets/Shape.png"
foto2.appendChild(shape)

let textLVL2 = document.createElement("div")
textLVL2.className="div"
stato2.appendChild(textLVL2)
let h5_2 = document.createElement("h5")
h5_2.className="h5"
let h5text2 = document.createTextNode("Body scan")
h5_2.appendChild(h5text2)
textLVL2.appendChild(h5_2)
let paLVL2 = document.createElement("p")
paLVL2.className="p"
let paText2 = document.createTextNode("Level 2")
paLVL2.appendChild(paText2)
stato2.appendChild(paLVL2)
let line2 = document.createElement("img")
line2.src = "/mobile-profile/assets/linea-stats.png"
stato2.appendChild(line2)


let stato3 = document.createElement("div")
stato3.className="stato"
stati.appendChild(stato3)

let foto3 = document.createElement("div")
foto3.className="foto-obbiettivo"
stato3.appendChild(foto3)
let polmoni = document.createElement("img")
polmoni.src = "/mobile-profile/assets/polmoni.png"
foto3.appendChild(polmoni)

let textLVL3 = document.createElement("div")
textLVL3.className="div"
stato3.appendChild(textLVL3)
let h5_3 = document.createElement("h5")
h5_3.className="h5"
let h5text3 = document.createTextNode("Body scan")
h5_3.appendChild(h5text3)
textLVL3.appendChild(h5_3)
let paLVL3 = document.createElement("p")
paLVL3.className="p"
let paText3 = document.createTextNode("Level 2")
paLVL3.appendChild(paText3)
stato3.appendChild(paLVL3)
let line3 = document.createElement("img")
line3.src = "/mobile-profile/assets/linea-stats.png"
stato3.appendChild(line3)
