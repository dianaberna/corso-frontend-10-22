function elementi (tipo, classe, attributi, padre, contenuto, extra) {
...
let divTop = elementi ("div", "top","",document.body)
...
let divProfile = elementi ("div", "profile","",document.body)
...
let statics = elementi ("div", "statics","",document.body)
let text_stats = elementi ("div", "text-stats","",statics)
elementi("span", "span", "", text_stats, "Time trained", "")
elementi("span", "span", "", text_stats, "Time trained", "Daily streak")
let number_stats = elementi ("div", "number-stats","",statics)
elementi("h3","", "", number_stats, "45min", "")
elementi("h3","", "", number_stats, "3 days", "")

let center = elementi ("div","center")
document.body.appendChild(center)
elementi("span","skills","",center,"Skills","")
elementi("span","badges","",center,"Badges","")

let stati = elementi ("div", "stati")
document.body.appendChild(stati)

let statoArray =
[{
    attributi:{src:"/mobile-profile/assets/ginocchio-martello.png", alt:"martello su ginocchio"},
    titolo:"Breath Focus",
    paragrafo:"Level 2",
    loading:{src:"/mobile-profile/assets/linea-stats.png", alt:"progressione"}
},
{
    attributi:{src:"/mobile-profile/assets/Shape.png" ,alt:"martello su ginocchio"},
    titolo:"Body scan",
    paragrafo:"Level 2",
    loading:{src:"/mobile-profile/assets/linea-stats.png", alt:"progressione"}
},
{
    attributi:{src:"/mobile-profile/assets/polmoni.png" ,alt:"martello su ginocchio"},
    titolo:"Body scan",
    paragrafo:"Level 2",
    loading:{src:"/mobile-profile/assets/linea-stats.png", alt:"progressione"}
}]

for (let j=0; j<statoArray.length; j++) {
    let stato = elementi ("div", "stato","",stati)
    elementi("img","foto-obbiettivo", statoArray[j].attributi, stato,"")
    let textLVL = elementi ("div", "div","",stato)
    elementi("h5","h5","",textLVL, statoArray[j].titolo)
    elementi("p","p","",textLVL, statoArray[j].paragrafo)
    elementi("img","line",statoArray[j].loading,textLVL, "")
}


let nav = elementi ("nav","nav")
document.body.appendChild(nav)
let menu_basso = elementi ("div","menu-basso")
