...
function sommaFunzione(primonumero, secondonumero) {
    ...
    var provavar = 6;
    console.log(s);
    return [s, prova, provavar]; // esce dalla funzione
}
...
function modificaArray(array, moltiplicatore) {
    ...
    return array; // se non ho il return metto il console.log all interno dell funzione, fuori mi richiamo  solo la funzione
}
